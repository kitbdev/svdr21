// GENERATED AUTOMATICALLY FROM 'Assets/Samples/XR Interaction Toolkit/1.0.0-pre.2/Default Input Actions/XRControls.inputactions'
...
public class @XRControls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""PrimaryHand"",
            ""id"": ""96d2211f-6fcf-4bf4-a193-612e502effce"",
            ""actions"": [
                {
                    ""name"": ""SelectMove"",
                    ""type"": ""Value"",
        ...
        {
            ""name"": ""NonVR"",
            ""id"": ""22ed62aa-9fef-4da4-8b1b-b2c8516927d3"",
            ""actions"": [
                {
                    ""name"": ""ShootBow"",
                    ""type"": ""Button"",
                    ""id"": ""0eb3c8ec-41fb-409c-9400-e17ff4d24ed7"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""AimCamera"",
                    ""type"": ""Value"",
                    ""id"": ""d99594b8-1df8-45b8-86ae-8f337444a41a"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""d1a64c48-8fa3-49e4-80a1-66e0243bbe6e"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""ChooseArrow"",
                    ""type"": ""Value"",
                    ""id"": ""1b122ce8-9592-4183-8ac4-2b8bab6a4f2d"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4ee9394a-506f-4fa8-9df7-516c6563ccce"",
                ...
                {
                    ""name"": """",
                    ""id"": ""cd7740a9-98fb-4bee-a82c-ed5612a128c4"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""NonVR"",
                ...
                {
                    ""name"": ""wasd"",
                    ""id"": ""8ab1d829-dca3-4d1f-af13-6f1b24d0ce10"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""3c3c17a1-cfe3-4d52-bbba-d1481bfa13e6"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""NonVR"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""fdd14d6c-960e-4da5-aa83-a74014704adf"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""NonVR"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""f2e78e47-c152-4f83-a8e0-24f5060acc50"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""NonVR"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""1635f3e2-bc02-44f8-862e-6cc296bc1812"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""NonVR"",
                ...
                {
                    ""name"": """",
                    ""id"": ""85f36b28-8d3b-4091-b5b7-95a16f910f24"",
                    ""path"": ""<Mouse>/scroll/y"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""NonVR"",
    ...
    ""controlSchemes"": [
        ...
        // PrimaryHand
        m_PrimaryHand = asset.FindActionMap("PrimaryHand", throwIfNotFound: true);
        m_PrimaryHand_SelectMove = m_PrimaryHand.FindAction("SelectMove", throwIfNotFound: true);
        // NonVR
        m_NonVR = asset.FindActionMap("NonVR", throwIfNotFound: true);
        m_NonVR_ShootBow = m_NonVR.FindAction("ShootBow", throwIfNotFound: true);
        m_NonVR_AimCamera = m_NonVR.FindAction("AimCamera", throwIfNotFound: true);
        m_NonVR_Move = m_NonVR.FindAction("Move", throwIfNotFound: true);
        m_NonVR_ChooseArrow = m_NonVR.FindAction("ChooseArrow", throwIfNotFound: true);
    }
    ...
    public struct XRIHMDActions
    {
        ...
        public XRIHMDActions(@XRControls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRControls m_Wrapper;
        public XRILeftHandActions(@XRControls wrapper) { m_Wrapper = wrapper; }
    ...
    // PrimaryHand
    private readonly InputActionMap m_PrimaryHand;
    private IPrimaryHandActions m_PrimaryHandActionsCallbackInterface;
    private readonly InputAction m_PrimaryHand_SelectMove;
    public struct PrimaryHandActions
    {
        private @XRControls m_Wrapper;
        public PrimaryHandActions(@XRControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @SelectMove => m_Wrapper.m_PrimaryHand_SelectMove;
        public InputActionMap Get() { return m_Wrapper.m_PrimaryHand; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(PrimaryHandActions set) { return set.Get(); }
        public void SetCallbacks(IPrimaryHandActions instance)
        {
            if (m_Wrapper.m_PrimaryHandActionsCallbackInterface != null)
            {
                @SelectMove.started -= m_Wrapper.m_PrimaryHandActionsCallbackInterface.OnSelectMove;
                @SelectMove.performed -= m_Wrapper.m_PrimaryHandActionsCallbackInterface.OnSelectMove;
                @SelectMove.canceled -= m_Wrapper.m_PrimaryHandActionsCallbackInterface.OnSelectMove;
            }
            m_Wrapper.m_PrimaryHandActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    public PrimaryHandActions @PrimaryHand => new PrimaryHandActions(this);

    // NonVR
    private readonly InputActionMap m_NonVR;
    private INonVRActions m_NonVRActionsCallbackInterface;
    private readonly InputAction m_NonVR_ShootBow;
    private readonly InputAction m_NonVR_AimCamera;
    private readonly InputAction m_NonVR_Move;
    private readonly InputAction m_NonVR_ChooseArrow;
    public struct NonVRActions
    {
        private @XRControls m_Wrapper;
        public NonVRActions(@XRControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @ShootBow => m_Wrapper.m_NonVR_ShootBow;
        public InputAction @AimCamera => m_Wrapper.m_NonVR_AimCamera;
        public InputAction @Move => m_Wrapper.m_NonVR_Move;
        public InputAction @ChooseArrow => m_Wrapper.m_NonVR_ChooseArrow;
        ...
        public void SetCallbacks(INonVRActions instance)
        {
            ...
            {
                @ShootBow.started -= m_Wrapper.m_NonVRActionsCallbackInterface.OnShootBow;
                @ShootBow.performed -= m_Wrapper.m_NonVRActionsCallbackInterface.OnShootBow;
                @ShootBow.canceled -= m_Wrapper.m_NonVRActionsCallbackInterface.OnShootBow;
                @AimCamera.started -= m_Wrapper.m_NonVRActionsCallbackInterface.OnAimCamera;
                @AimCamera.performed -= m_Wrapper.m_NonVRActionsCallbackInterface.OnAimCamera;
                @AimCamera.canceled -= m_Wrapper.m_NonVRActionsCallbackInterface.OnAimCamera;
                @Move.started -= m_Wrapper.m_NonVRActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_NonVRActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_NonVRActionsCallbackInterface.OnMove;
                @ChooseArrow.started -= m_Wrapper.m_NonVRActionsCallbackInterface.OnChooseArrow;
                @ChooseArrow.performed -= m_Wrapper.m_NonVRActionsCallbackInterface.OnChooseArrow;
                @ChooseArrow.canceled -= m_Wrapper.m_NonVRActionsCallbackInterface.OnChooseArrow;
            }
            ...
            if (instance != null)
            {
                ...
                @Move.performed += instance.OnMove;
                @Move.canceled += instance.OnMove;
                @ChooseArrow.started += instance.OnChooseArrow;
                @ChooseArrow.performed += instance.OnChooseArrow;
                @ChooseArrow.canceled += instance.OnChooseArrow;
            }
        }
    }
    ...
    private int m_NonVRSchemeIndex = -1;
    public InputControlScheme NonVRScheme
    {
        get
        {
            if (m_NonVRSchemeIndex == -1) m_NonVRSchemeIndex = asset.FindControlSchemeIndex("NonVR");
            return asset.controlSchemes[m_NonVRSchemeIndex];
        }
    }
    ...
    public interface IPrimaryHandActions
    {
    ...
    public interface INonVRActions
    {
        ...
        void OnMove(InputAction.CallbackContext context);
        void OnChooseArrow(InputAction.CallbackContext context);
    }
}
