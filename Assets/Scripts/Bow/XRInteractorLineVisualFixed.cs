...
// see \Library\PackageCache\com.unity.xr.interaction.toolkit@1.0.0-pre.2\Runtime\Interaction\Interactors\Helpers\XRInteractorLineVisual.cs
...
public class XRInteractorLineVisualFixed : MonoBehaviour, IXRCustomReticleProvider
{
    ...
    void UpdateLineVisual()
    {
        ...
        if (m_PreviousRenderPoints.Length > 0)
        {
